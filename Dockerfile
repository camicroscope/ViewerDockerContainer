...
RUN git clone -b '2.0' --single-branch https://github.com/camicroscope/Security.git /var/www/html
RUN git clone -b '2.0' --single-branch https://github.com/camicroscope/caMicroscope.git /var/www/html/camicroscope
