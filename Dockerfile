...
RUN git clone -b lymphocyte https://github.com/ajasniew/caMicroscope.git /var/www/html/lymphocyte
RUN git clone https://github.com/SBU-BMI/camicSignup.git /var/www/html/camicSignup
