...
var schema = {    
  ...
  var formSchema = {
   ...
   setTimeout(function(){
    ...
    jQuery("#workOrderForm").append("<div id='workOrderCtrl'><br /><button class='btn' id='submitWorkOrder'>Analyze Region</button><br /><button class='btn btn-success' id='saveWorkOrder'>Save Results</button> <button class='btn-danger' id='discardWorkOrder'>Discard Results</button></div>");
    jQuery('#cancelWorkOrder').click(function (e) {
      e.preventDefault();
      //console.log('here')
      jQuery('#panel').hide()
